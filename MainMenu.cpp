...
void CALLBACK CMainMenu::Init(){
	...
	_pBackSprite->SetTexture("background.png");             // Назначаем используемую спрайтом текстуру.
	
	_pButtonAnim->SetTexture("new_game.png");               // Назначаем используемую анимацией текстуру.
	...
	_pManagementSprite->SetTexture("BackgroundOfManagement.png");

	_pButtonBack->SetTexture("back.png");						
